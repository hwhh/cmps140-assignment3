...
class AI(BasePlayer):
    ...
    def evalCost(self, b, opp_board, my_board, b_my_turn):
        ...
        if self.has_won(opp_board):
            return -win_reward
        elif self.has_won(my_board):
            return win_reward
    ...
    def search(self, board):
        ...
        g.alphabeta(board, self, g.root, max_depth, float('-inf'), float('inf'))
        return g.get_move()
    ...
    def forced_moves(self, board):
        ...
        for colbitTuple in possible_bits:
            ...
            if self.has_won(temp_my_board):
                return colbitTuple[0]
            elif self.has_won(temp_opp_board):
